JAZZMIN_SETTINGS = {
    ...
    "copyright": "Linh Trang Bridal",

    # List of model admins to search from the search bar, search bar omitted if excluded
    # If you want to use a single search field you dont need to use a list, you can use a simple string 
    "search_model": ["orders.Cart", ],
    ...
    "order_with_respect_to": [ "order","bills","report","clients","services_admin","members","event_calendar","auth",],
    ...
    "icons": {
        ...
        "order.ReturnClothe": "fas fa-undo",
        "order.ReturnAccessory": "fas fa-sort-amount-down",
        "services_admin.clothe":"fas fa-vest",
